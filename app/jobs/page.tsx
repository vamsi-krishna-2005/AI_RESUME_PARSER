          ...
          <div className="flex flex-col lg:flex-row gap-4 mb-4">
            ...
            <div className="flex gap-4">
              <input
                ...
                className="w-40 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
              />
              <button
                onClick={() => setShowFilters(!showFilters)}
                className="px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200 cursor-pointer flex items-center space-x-2 whitespace-nowrap"
              >
          ...
          {filteredJobs.map((job, index) => (
            <div 
              ...
              className={`bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 p-6 ${
                index === 0 && searchParams.get('newJob') ? 'ring-2 ring-green-500 bg-green-50' : ''
              }`}
            >
                ...
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-3">
                      <button className="px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200 cursor-pointer whitespace-nowrap">
                        Apply Now
                      </button>
                      <button className="px-6 py-2 border border-gray-300 text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition-colors duration-200 cursor-pointer whitespace-nowrap">
                        Save Job
                      </button>
